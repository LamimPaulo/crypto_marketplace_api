        ...
        <div style="background-color: #222533; width: 100%; height: 100%; padding: 20px;">
            ...
            <div
                ...
                <div style="color: #000000; padding: 60px 70px; border-top: 1px solid rgba(0,0,0,0.05);">
                    ...
                    @if(isset($reason))
                        <div
                            style="padding: 8px 20px; color: #4B72FA; font-weight: bolder; font-size: 24px; display: inline-block; margin: 20px 0px; margin-right: 20px; width: 100%; text-align: center">
                            {{ $reason }}
                        </div>
                    @endif
                ...
                <div style="background-color: #F5F5F5; padding: 40px; text-align: center;">
                    ...
                    <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(0,0,0,0.05);">
                        ...
                        <div style="color: #A5A5A5; font-size: 10px;">
                            Navi Capital {{date('Y')}}. {{ trans('mail.rights') }}
                        </div>
                    </div>
                </div>
            </div>
